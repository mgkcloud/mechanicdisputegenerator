...
/**
 * Formats FormData for logging by creating a new object with all entries
 * Handles File objects by replacing them with a description
 * @param {FormData} formData - The FormData object to format
 * @returns {Object} An object representation of the FormData
 */
export function formatFormDataLog(formData) {
  const formDataLog = {};
