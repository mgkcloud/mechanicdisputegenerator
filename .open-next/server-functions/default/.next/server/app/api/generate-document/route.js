(()=>{var e={};e.id=767,e.ids=[767],e.modules={3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},6426:(e,t,a)=>{"use strict";a.d(t,{DM:()=>i});let r=Symbol.for("__cloudflare-context__");function i(e={async:!1}){return e.async?o():function(){let e=n();if(e)return e;if(function(){let e=globalThis;return e.__NEXT_DATA__?.nextExport===!0}())throw Error("\n\nERROR: `getCloudflareContext` has been called in sync mode in either a static route or at the top level of a non-static one, both cases are not allowed but can be solved by either:\n  - make sure that the call is not at the top level and that the route is not static\n  - call `getCloudflareContext({async: true})` to use the `async` mode\n  - avoid calling `getCloudflareContext` in the route\n");throw Error(c)}()}function n(){return globalThis[r]}async function o(){let e=n();if(e)return e;{let e=await s();return function(e){globalThis[r]=e}(e),e}}async function s(e){let{getPlatformProxy:t}=await import(`${"__wrangler".replaceAll("_","")}`),a=e?.environment??process.env.NEXT_DEV_WRANGLER_ENV,{env:r,cf:i,ctx:n}=await t({...e,environment:a});return{env:r,cf:i,ctx:n}}let c='\n\nERROR: `getCloudflareContext` has been called without having called `initOpenNextCloudflareForDev` from the Next.js config file.\nYou should update your Next.js config file as shown below:\n\n   ```\n   // next.config.mjs\n\n   import { initOpenNextCloudflareForDev } from "@opennextjs/cloudflare";\n\n   initOpenNextCloudflareForDev();\n\n'+"   const nextConfig = { ... };\n   export default nextConfig;\n   ```\n\n"},10846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},23870:(e,t,a)=>{"use strict";a.d(t,{A:()=>c});var r=a(55511);let i={randomUUID:r.randomUUID},n=new Uint8Array(256),o=n.length,s=[];for(let e=0;e<256;++e)s.push((e+256).toString(16).slice(1));let c=function(e,t,a){if(i.randomUUID&&!t&&!e)return i.randomUUID();let c=(e=e||{}).random??e.rng?.()??(o>n.length-16&&((0,r.randomFillSync)(n),o=0),n.slice(o,o+=16));if(c.length<16)throw Error("Random bytes length must be >= 16");if(c[6]=15&c[6]|64,c[8]=63&c[8]|128,t){if((a=a||0)<0||a+16>t.length)throw RangeError(`UUID byte range ${a}:${a+15} is out of buffer bounds`);for(let e=0;e<16;++e)t[a+e]=c[e];return t}return function(e,t=0){return(s[e[t+0]]+s[e[t+1]]+s[e[t+2]]+s[e[t+3]]+"-"+s[e[t+4]]+s[e[t+5]]+"-"+s[e[t+6]]+s[e[t+7]]+"-"+s[e[t+8]]+s[e[t+9]]+"-"+s[e[t+10]]+s[e[t+11]]+s[e[t+12]]+s[e[t+13]]+s[e[t+14]]+s[e[t+15]]).toLowerCase()}(c)}},29294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},32584:(e,t,a)=>{"use strict";a.d(t,{Rv:()=>n,hD:()=>r,hS:()=>i});class r extends Error{constructor(e,t=500,a=null){super(e),this.name="ApiError",this.statusCode=t,this.details=a}}function i(e){return(console.error("API Error:",e),e instanceof r)?{success:!1,error:e.message,details:e.details,statusCode:e.statusCode}:{success:!1,error:e.message||"An unexpected error occurred",statusCode:500}}function n(e,t){let a=t.filter(t=>!e[t]);if(a.length>0)throw new r(`Missing required fields: ${a.join(", ")}`,400,{missingFields:a})}},33678:(e,t,a)=>{"use strict";a.r(t),a.d(t,{patchFetch:()=>b,routeModule:()=>y,serverHooks:()=>A,workAsyncStorage:()=>v,workUnitAsyncStorage:()=>w});var r={};a.r(r),a.d(r,{POST:()=>f});var i=a(96559),n=a(48088),o=a(37719),s=a(32190),c=a(23870),l=a(77754);async function d(e){try{let t;let a=e.customer_name,r=e.customer_address,i=e.customer_phone,n=e.customer_email,o=e.mechanic_name,s=e.mechanic_address,d=e.mechanic_abn||"Not provided",u=e.vehicle_make,m=e.vehicle_model,h=e.vehicle_year,p=e.vehicle_rego,g=e.service_date,f=e.damage_description,y=e.repair_cost,v=e.payment_method,w=e.invoice_number,A="yes"===e.photo_evidence,b="yes"===e.independent_quote,C="yes"===e.insurance_claim,D=e.insurance_excess||"",I=e.insurance_claim_number||"",_=e.response_deadline||"7 days",E=`Generate a formal Letter of Demand to a mechanic in Australia regarding vehicle damage that occurred during servicing.
...
Photo Evidence Available: ${A?"Yes":"No"}
Independent Quote Obtained: ${b?"Yes":"No"}
...
**Task:**
1.  Select the appropriate base template structure for a **${u[r]}**.
...
`;try{let e=process.env.OPENAI_API_KEY;if(!e)throw Error("OpenAI API key not configured");console.log("Calling OpenAI API for document generation...");let a=await fetch("https://api.openai.com/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e}`},body:JSON.stringify({model:"gpt-4-turbo",messages:[{role:"system",content:"You are an expert Australian legal assistant specializing in consumer law and mechanic disputes. Your role is to generate precise, legally sound, and effective documents (like Letters of Demand, CAV complaints, VCAT guidance) based on user input and provided Australian legal context. You must strictly adhere to the legal principles provided, integrate user details accurately, and ensure the final document protects the consumer's rights under Australian law, particularly the ACL and bailment principles. Avoid hallucinations and stick closely to the provided context and user details."},{role:"user",content:v}],max_tokens:4e3,temperature:.5})});if(!a.ok){let e=await a.json().catch(()=>({error:{message:"Unknown API error"}}));throw Error(`OpenAI API error: ${e.error?.message||"Unknown error"}`)}let r=await a.json().catch(()=>{throw Error("Failed to parse OpenAI API response")});if(!r.choices||!r.choices[0]||!r.choices[0].message||!r.choices[0].message.content)throw Error("Invalid or empty response from OpenAI API");if(t=r.choices[0].message.content,"string"!=typeof t||0===t.trim().length)throw Error("Empty or invalid document text received from OpenAI");t=t.replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F]/g,"")}catch(c){console.error("OpenAI API Error:",c),console.log("Falling back to template due to API error");let{getAustralianTemplate:e}=await Promise.resolve().then(a.bind(a,77754)),o=u[r]?r.toLowerCase().replace(/ /g,"_"):"default_template";t=e(o).replace(/\[Your Name\]/g,i||"[Your Name]").replace(/\[Mechanic Business Name\]/g,n||"[Mechanic Business Name]").replace(/\[Vehicle Make\]/g,l.split(" ")[1]||"[Vehicle Make]").replace(/\[Vehicle Model\]/g,l.split(" ")[2]||"[Vehicle Model]").replace(/\[Vehicle Year\]/g,l.split(" ")[0]||"[Vehicle Year]").replace(/\[Vehicle Registration\]/g,l.split("Rego: ")[1]||"[Vehicle Registration]").replace(/\[Service Date\]/g,d||"[Service Date]").replace(/\[Damage Description\]/g,h||"[Damage Description]").replace(/\[Repair Cost\]/g,p||"[Repair Cost]").replace(/\[State, e.g., Victoria\]/g,s||"[State]").replace(/\[Date\]/g,new Date().toLocaleDateString("en-AU"))}let w=(0,c.A)().substring(0,8),A=`au_${r}_${w}`;return{success:!0,documentText:t,filename:A,documentType:u[r]||"Australian Legal Document",customerName:i,mechanicName:n}}catch(e){throw console.error("Australian document generation error:",e),Error(`Failed to generate Australian document: ${e.message}`)}}var p=a(71777),g=a(32584);async function f(e){try{let t;let a=await e.formData(),r=a.get("document_type");(0,g.Rv)(Object.fromEntries(a.entries()),["document_type","customer_name","customer_email","mechanic_name","damage_description"]);let i=(t="letter_of_demand"===r?await d(Object.fromEntries(a.entries())):await h(Object.fromEntries(a.entries()))).letterText||t.documentText;if(!i)throw new g.hD("Document generation resulted in empty content.",500);let n=a.get("customer_name")||t.customerName||"Customer",o=function(e,t,a){let r;let i=new Date().toLocaleDateString("en-AU",{year:"numeric",month:"long",day:"numeric"});e&&"string"==typeof e||(console.error("Invalid text input:",e),e="Error: Document generation failed. Please try again.");try{e=(e=e.replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F]/g,"")).replace(/(\d{1,2}\/\d{1,2}\/\d{4}){2,}/g,e=>e.substring(0,10))}catch(t){console.error("Error sanitizing text:",t),e="Error sanitizing document text. Please regenerate the document."}try{r=e.split("\n")}catch(e){console.error("Error splitting text into paragraphs:",e),r=["Error processing document text. Please regenerate the document."]}let n="";for(let e of r)try{if(!e.trim())continue;let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;");if(t.trim().startsWith("#")){let e=t.replace(/#/g,"").trim();n+=`<h2 class="document-header">${e}</h2>`}else t.trim()===t.trim().toUpperCase()&&t.trim().length>3?n+=`<h2 class="document-header">${t.trim()}</h2>`:t.trim().startsWith("•")||t.trim().startsWith("-")||t.trim().startsWith("*")?n+=`<p class="document-bullet">${t.trim()}</p>`:t.toLowerCase().includes("signature")||t.toLowerCase().includes("sign")||t.toLowerCase().includes("date:")?n+=`<p class="document-signature">${t}</p>`:n+=`<p class="document-paragraph">${t}</p>`}catch(e){console.error("Error processing paragraph:",e),n+='<p class="document-paragraph">Error processing paragraph.</p>'}let o=t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),s=a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;");return`
  ...
  `}(i,n,t.documentType),c=t.filename;return await (0,p.FN)(c,o,{contentType:"text/html",metadata:{documentType:t.documentType,customerName:n,filenameBase:c}}),s.NextResponse.json({success:!0,filename:c,documentType:t.documentType,customerName:n,generatedDate:new Date().toISOString()})}catch(t){let e=(0,g.hS)(t);return s.NextResponse.json(e,{status:e.statusCode})}}let y=new i.AppRouteRouteModule({definition:{kind:n.RouteKind.APP_ROUTE,page:"/api/generate-document/route",pathname:"/api/generate-document",filename:"route",bundlePath:"app/api/generate-document/route"},resolvedPagePath:"/Users/wlvar/Downloads/mechanicdisputecfworker (2)/app/api/generate-document/route.js",nextConfigOutput:"standalone",userland:r}),{workAsyncStorage:v,workUnitAsyncStorage:w,serverHooks:A}=y;function b(){return(0,o.patchFetch)({workAsyncStorage:v,workUnitAsyncStorage:w})}},44870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},55511:e=>{"use strict";e.exports=require("crypto")},63033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},71777:(e,t,a)=>{"use strict";a.d(t,{FN:()=>o,Pc:()=>c,YE:()=>s});var r=a(6426),i=a(55511);async function n(){try{return(await (0,r.DM)({async:!0})).env||{}}catch(e){return console.warn("Not running in Cloudflare Workers context, using process.env:",e.message),process.env}}async function o(e,t,a={}){let{contentType:r="text/html",metadata:s={},format:c="html"}=a,l=`${e}.${c}`;try{let a=await n(),o=a.DOCUMENTS_BUCKET;if(o)await o.put(l,t,{httpMetadata:{contentType:r,cacheControl:"public, max-age=31536000"},customMetadata:{...s,createdAt:new Date().toISOString()}});else{if(!a.S3_ACCESS_KEY||!a.S3_SECRET_KEY||!a.S3_BUCKET_NAME)throw Error("Missing required S3 environment variables");let e=a.S3_REGION||"us-east-1",n=a.S3_BUCKET_NAME,o=a.S3_ENDPOINT?a.S3_ENDPOINT.replace(/^https?:\/\//,""):`s3.${e}.amazonaws.com`,s=function(e){let{accessKey:t,secretKey:a,region:r,bucket:n,key:o,contentType:s,expires:c=3600,host:l,method:d="PUT"}=e,u=new Date,m=u.toISOString().replace(/[:-]|\.\d{3}/g,"").substring(0,8),h=u.toISOString().replace(/[:-]|\.\d{3}/g,"");u.getTime();let p={method:d,path:`/${o}`,query:{"X-Amz-Algorithm":"AWS4-HMAC-SHA256","X-Amz-Credential":`${t}/${m}/${r}/s3/aws4_request`,"X-Amz-Date":h.slice(0,16)+"Z","X-Amz-Expires":c.toString(),"X-Amz-SignedHeaders":"host"},headers:{host:l}};s&&(p.query["Content-Type"]=s);let g=Object.keys(p.query).sort().map(e=>`${encodeURIComponent(e)}=${encodeURIComponent(p.query[e])}`).join("&"),f=[p.method,p.path,g,"host:"+p.headers.host+"\n","host","UNSIGNED-PAYLOAD"].join("\n"),y=["AWS4-HMAC-SHA256",p.query["X-Amz-Date"],`${m}/${r}/s3/aws4_request`,i.createHash("sha256").update(f).digest("hex")].join("\n"),v=function(e,t,a){let r=i.createHmac("sha256","AWS4"+e).update(t).digest(),n=i.createHmac("sha256",r).update(a).digest(),o=i.createHmac("sha256",n).update("s3").digest();return i.createHmac("sha256",o).update("aws4_request").digest()}(a,m,r),w=i.createHmac("sha256",v).update(y).digest("hex");p.query["X-Amz-Signature"]=w;let A=Object.keys(p.query).map(e=>`${encodeURIComponent(e)}=${encodeURIComponent(p.query[e])}`).join("&");return`https://${l}${p.path}?${A}`}({accessKey:a.S3_ACCESS_KEY,secretKey:a.S3_SECRET_KEY,region:e,bucket:n,key:`${n}/${l}`,contentType:r,host:o,method:"PUT"}),c=await fetch(s,{method:"PUT",headers:{"Content-Type":r,"Cache-Control":"public, max-age=31536000"},body:t});if(!c.ok)throw Error(`Failed to upload document: ${c.status} ${c.statusText}`)}return`/api/documents/${e}`}catch(e){throw console.error("Error storing document:",e),Error(`Failed to store document: ${e.message}`)}}async function s(e){try{let t=e.endsWith(".html")?e:`${e}.html`,a=await n(),r=a.DOCUMENTS_BUCKET;if(r){let e=await r.get(t);if(null===e)return null;return await e.text()}{if(!a.S3_ACCESS_KEY||!a.S3_SECRET_KEY||!a.S3_BUCKET_NAME)throw Error("Missing required S3 environment variables");let e=a.S3_REGION||"us-east-1",r=a.S3_BUCKET_NAME,i=a.S3_ENDPOINT||`https://s3.${e}.amazonaws.com`,n=`${i}/${r}/${t}`,o=await fetch(n);if(!o.ok){if(404===o.status)return null;throw Error(`Failed to get document: ${o.status} ${o.statusText}`)}return await o.text()}}catch(e){if("NoSuchKey"===e.name||"NotFound"===e.name||e.message.includes("404"))return null;throw console.error("Error retrieving document:",e),Error(`Failed to retrieve document: ${e.message}`)}}async function c(e){try{let t=await n(),a=t.DOCUMENTS_BUCKET;if(a){let t=await a.head(e);if(null===t)return null;return{contentType:t.httpMetadata?.contentType,metadata:t.customMetadata,lastModified:t.uploaded,contentLength:t.size}}{if(!t.S3_ACCESS_KEY||!t.S3_SECRET_KEY||!t.S3_BUCKET_NAME)throw Error("Missing required S3 environment variables");let a=t.S3_REGION||"us-east-1",r=t.S3_BUCKET_NAME,i=t.S3_ENDPOINT||`https://s3.${a}.amazonaws.com`,n=`${i}/${r}/${e}`,o=await fetch(n,{method:"HEAD"});if(!o.ok){if(404===o.status)return null;throw Error(`Failed to get document metadata: ${o.status} ${o.statusText}`)}return{contentType:o.headers.get("Content-Type"),contentLength:parseInt(o.headers.get("Content-Length")||"0"),lastModified:new Date(o.headers.get("Last-Modified")),metadata:{}}}}catch(e){if("NotFound"===e.name||"NoSuchKey"===e.name||e.message.includes("404"))return null;throw console.error("Error retrieving document metadata:",e),Error(`Failed to retrieve document metadata: ${e.message}`)}}},77754:(e,t,a)=>{"use strict";a.d(t,{getAustralianTemplate:()=>n});let r={default_template:`
[Your Name]
[Your Address]
[Your Phone]
[Your Email]
...
Yours faithfully,
[Your Name]`}}},78335:()=>{},96487:()=>{}};var t=require("../../../webpack-runtime.js");t.C(e);var a=e=>t(t.s=e),r=t.X(0,[447,580],()=>a(33678));module.exports=r})();