(()=>{var e={};e.id=501,e.ids=[501],e.modules={3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},10846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},29294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},44870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},63033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},65671:(e,a,t)=>{"use strict";t.r(a),t.d(a,{patchFetch:()=>f,routeModule:()=>m,serverHooks:()=>p,workAsyncStorage:()=>u,workUnitAsyncStorage:()=>h});var i={};t.r(i),t.d(i,{GET:()=>d,dynamic:()=>l});var r=t(96559),o=t(48088),n=t(37719),s=t(32190),c=t(77754);let l="force-dynamic";async function d(e){try{let{searchParams:a}=new URL(e.url),t=a.get("type");if(!t)return s.NextResponse.json({error:"Missing template type parameter"},{status:400});console.log("Template type requested:",t);let i=(0,c.getAustralianTemplate)(t);return i=i.replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F]/g,""),new s.NextResponse(i,{headers:{"Content-Type":"text/plain"}})}catch(a){console.error("Template retrieval error:",a);let e=`
[Your Name]
[Your Address]
...
Yours faithfully,
[Your Name]`;return new s.NextResponse(e,{headers:{"Content-Type":"text/plain"}})}}let m=new r.AppRouteRouteModule({definition:{kind:o.RouteKind.APP_ROUTE,page:"/api/get-template/route",pathname:"/api/get-template",filename:"route",bundlePath:"app/api/get-template/route"},resolvedPagePath:"/Users/wlvar/Downloads/mechanicdisputecfworker (2)/app/api/get-template/route.js",nextConfigOutput:"standalone",userland:i}),{workAsyncStorage:u,workUnitAsyncStorage:h,serverHooks:p}=m;function f(){return(0,n.patchFetch)({workAsyncStorage:u,workUnitAsyncStorage:h})}},77754:(e,a,t)=>{"use strict";t.d(a,{getAustralianTemplate:()=>o});let i={default_template:`
[Your Name]
[Your Address]
[Your Phone]
[Your Email]
...
[Your Name]
  `},r={letter_of_demand:"letter_of_demand",consumer_complaint:"consumer_complaint",vcat_application:"vcat_application",insurance_claim:"insurance_claim"};function o(e){try{let a="string"==typeof e?e.trim().toLowerCase():"default_template",t=r[a]||a,o=i[t]||i.default_template;if(!o)return console.error(`Template not found for document type: ${a}, mapped to key: ${t}`),"Template not found. Please try a different document type.";return o=(o=(o=(o=(o=o.replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F]/g,"")).replace(/(\d{1,2}\/\d{1,2}\/\d{4}){2,}/g,e=>e.substring(0,10))).replace(/\d{4}-\d{2}-\d{2}\d+/g,e=>e.substring(0,10))).replace(/(y\d{1,2}\/\d{1,2}\/\d{4}){2,}/g,e=>e.substring(0,e.length/2))).replace(/(\d{2,}){3,}/g,"")}catch(e){return console.error("Error in getAustralianTemplate:",e),`An error occurred while retrieving the template. Please try again.
...
Yours faithfully,
[Your Name]`}}},78335:()=>{},96487:()=>{}};var a=require("../../../webpack-runtime.js");a.C(e);var t=e=>a(a.s=e),i=a.X(0,[447,580],()=>t(65671));module.exports=i})();