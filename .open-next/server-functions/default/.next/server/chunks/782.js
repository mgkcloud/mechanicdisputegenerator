"use strict";exports.id=782,exports.ids=[782],exports.modules={43782:(e,a,i)=>{i.d(a,{getAustralianTemplate:()=>o});let t={default_template:`
[Your Name]
[Your Address]
[Your Phone]
[Your Email]
...
[Your Name]
  `},r={letter_of_demand:"letter_of_demand",consumer_complaint:"consumer_complaint",vcat_application:"vcat_application",insurance_claim:"insurance_claim"};function o(e){try{let a="string"==typeof e?e.trim().toLowerCase():"default_template",i=r[a]||a,o=t[i]||t.default_template;if(!o)return console.error(`Template not found for document type: ${a}, mapped to key: ${i}`),"Template not found. Please try a different document type.";return o=(o=(o=(o=(o=o.replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F]/g,"")).replace(/(\d{1,2}\/\d{1,2}\/\d{4}){2,}/g,e=>e.substring(0,10))).replace(/\d{4}-\d{2}-\d{2}\d+/g,e=>e.substring(0,10))).replace(/(y\d{1,2}\/\d{1,2}\/\d{4}){2,}/g,e=>e.substring(0,e.length/2))).replace(/(\d{2,}){3,}/g,"")}catch(e){return console.error("Error in getAustralianTemplate:",e),`An error occurred while retrieving the template. Please try again.
